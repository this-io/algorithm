...
public class MinimumNumberOfSessionsToCompleteTask {
    public static void main(String[] args) {
        MinimumNumberOfSessionsToCompleteTask m = new MinimumNumberOfSessionsToCompleteTask();
        int[] ip = {1,2,3};
        System.out.println(m.minSessions(ip, 3));
    }
